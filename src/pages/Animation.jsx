      ...
      <div style={{ width: "60%", minWidth: "820px" }}>
        ...
        <div className="d-flex justify-content-between align-items-center py-4">
          ...
          <div className="d-flex gap-2 flex-wrap">
            <button
              className={`btn ${
                ballType === 0 ? "btn-secondary" : "btn-outline-secondary"
              }`}
            ...
            <button
              className={`btn ${
                ballType === 1 ? "btn-primary" : "btn-outline-primary"
              }`}
            ...
            <button
              className={`btn ${
                ballType === 2 ? "btn-primary" : "btn-outline-primary"
              }`}
            ...
            <button
              className={`btn ${
                ballType === 3 ? "btn-primary" : "btn-outline-primary"
              }`}
            ...
            <button
              className={`btn ${
                ballType === 4 ? "btn-primary" : "btn-outline-primary"
              }`}
            ...
            <button
              className={`btn ${
                ballType === 5 ? "btn-primary" : "btn-outline-primary"
              }`}
            ...
            <button
              className={`btn ${
                ballType === 6 ? "btn-primary" : "btn-outline-primary"
              }`}
